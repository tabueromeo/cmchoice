...
let SubCategoryControls = require("../controllers/subCategoryController");
...
subCategoryRoutes
	...
	.post(authMiddleWare, SubCategoryControls.createSubCategory);

// This section will help you get a single subCategory by id
subCategoryRoutes
	.route("/api/v1/subCategories/:id")
	.get(SubCategoryControls.getSubCategory);

// This section will help you update a subCategory by id.
subCategoryRoutes
	.route("/api/v1/subCategories/:id")
	.put(authMiddleWare, SubCategoryControls.updateSubCategory);

// This section will help you delete a subCategory
subCategoryRoutes
	.route("/api/v1/subCategories/:id")
	.delete(authMiddleWare, SubCategoryControls.deleteSubCategory);
