...
let commandControls = require("../controllers/commandController");
...
commandRoutes
	...
	.post(authMiddleWare, commandControls.createCommand);

// This section will help you get a list of all the commands.
commandRoutes
	.route("/api/v1/commands")
	.get(authMiddleWare, commandControls.all);

// This section will help you get a single command by id
commandRoutes
	.route("/api/v1/commands/:id")
	.get(authMiddleWare, commandControls.getCommand);

// This section will help you update a command by id.
commandRoutes
	.route("/api/v1/commands/:id")
	.put(authMiddleWare, commandControls.updateCommand);

// This section will help you delete a command
commandRoutes
	.route("/api/v1/commands/:id")
	.delete(authMiddleWare, commandControls.deleteCommand);
