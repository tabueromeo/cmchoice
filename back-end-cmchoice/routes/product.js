...
let productControls = require("../controllers/productController");
...
productRoutes
	...
	.post(authMiddleWare, productControls.create);
...
productRoutes
	...
	.put(authMiddleWare, productControls.updateProduct);

// This section will help you delete a product
productRoutes
	.route("/api/v1/products/:id")
	.delete(authMiddleWare, productControls.deleteProduct);
