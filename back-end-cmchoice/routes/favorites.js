...
let favoriteControls = require("../controllers/favoriteController");
...
favoriteRoutes
	...
	.get(authMiddleWare, favoriteControls.all);

// This section will help you create a favorites.
favoriteRoutes
	.route("/api/v1/favorites")
	.post(authMiddleWare, favoriteControls.createFavoriteList);

// This section will help you get a single favorite by id
favoriteRoutes
	.route("/api/v1/favorites/:id")
	.get(authMiddleWare, favoriteControls.getFavoriteList);

// This section will help you update a favorite by id.
favoriteRoutes
	.route("/api/v1/favorites/:id")
	.put(authMiddleWare, favoriteControls.updateFavoriteList);

// This section will help you delete a favorite
favoriteRoutes
	.route("/api/v1/favorites/:id")
	.delete(authMiddleWare, favoriteControls.deleteFavoriteList);
