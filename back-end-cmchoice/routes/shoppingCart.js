...
let shoppingCartControls = require("../controllers/shoppingCartController");
...
shoppingCartRoutes
	...
	.get(authMiddleWare, shoppingCartControls.all);

// This section will help you create a shoppingCarts.
shoppingCartRoutes
	.route("/api/v1/shoppingcarts")
	.post(authMiddleWare, shoppingCartControls.createCart);

// This section will help you get a single shoppingCart by id
shoppingCartRoutes
	.route("/api/v1/shoppingcarts/:id")
	.get(authMiddleWare, shoppingCartControls.getShoppingCart);

// This section will help you update a shoppingCart by id.
shoppingCartRoutes
	.route("/api/v1/shoppingcarts/:id")
	.put(authMiddleWare, shoppingCartControls.updateShoppingCart);

// This section will help you delete a shoppingCart
shoppingCartRoutes
	.route("/api/v1/shoppingcarts/:id")
	.delete(authMiddleWare, shoppingCartControls.deleteShoppingCart);
