<template>
    <div class="container-section">
        ...
        <section class="cart-section pt-pb-5 bg-light">
          ...
          <br>
          <div class="bt-center">
            <button v-on:click="OpenPopup" id="clearProducts">delete products</button>
          </div>
          <!-- PRODUCTS -->
          <section class="py-5">
            <div id="productCards">
             <div v-for="element in products" :key="element.id"  class="product-card">
               <ProductSeller :productprop="element" />
             </div>
            </div>
          </section>
          <!-- DIALOG/POPUP -->
...
export default {
  ...
  computed: {
    ...mapState({
       products: state => state.AddProductMod.products
     }) , 
  },
