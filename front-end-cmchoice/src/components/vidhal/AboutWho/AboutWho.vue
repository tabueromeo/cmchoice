<template>
    <div class="container-section">
        ...
        <section class="cart-section pt-pb-5 bg-light">
          ...
          <!-- a-propos de nous-->
          <div class="a-propos position-relative  wow fadeInUp" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeInUp;" >
              <h2 class="text-center">A PROPOS DE NOUS</h2>
              <div class="a-propos-description text-center">
                  Lorem ipsum dolor sit amet consectetur 
                  adipisicing elit. Maxime tempora nam amet 
                  nemo quidem nostrum ratione, quas deserunt 
                  qui necessitatibus ad assumenda ex minus lab
                  orum? Ea natus eum eaque officiis.
              </div>
          </div>
          <!-- our-team-members-->
          <div class="our-team-members">
              <h2 class="text-center">Ours Team Members</h2>
...
/* our-team-members- */
.a-propos h2, .our-team-members h2 {
  font-size: 2rem;
}
.our-team-members, .a-propos{
  margin-top: 70px;
}
.team-description{
  margin-bottom: 20px;
...
.line1{
  border: 1px solid rgba(2, 2, 2, 0.501);
  width: 8%;
}
.line2{
  border: 1px solid rgba(2, 2, 2, 0.501);
