        ...
        <div class="container py-4">
          <div class="row py-5">
            <div class="col-md-4 mb-3 mb-md-0">
              <h6 class="text-uppercase mb-3">Service client</h6>
              <ul class="list-unstyled mb-0">
                <li><RouterLink to="/" class="footer-link">Aide &amp; Nous contacter</RouterLink></li>
                <!-- <li><a class="footer-link" href="#!">Returns &amp; Refunds</a></li>
                <li><a class="footer-link" href="#!">Online Stores</a></li> -->
                <li><RouterLink to="/" class="footer-link"> Conditions &amp; Termes</RouterLink></li>
                <li><RouterLink to="/" class="footer-link"> FAQs</RouterLink></li>
              </ul>
            </div>
            <div class="col-md-4 mb-3 mb-md-0">
              <h6 class="text-uppercase mb-3">Entreprise</h6>
              <ul class="list-unstyled mb-0">
                <li><RouterLink to="/" class="footer-link" href="#!">Qui sommes-nous ?</RouterLink></li>
                <li><RouterLink to="/" class="footer-link" href="#!">Notre équipe</RouterLink></li>
              </ul>
            </div>
            <div class="col-md-4">
              ...
              <!-- <ul class="list-unstyled mb-0">
                ...
                <div class="main">
                    ...
                    <div class="down">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="23px" height="23px"  class="facebook" viewBox="0 0 16 16"> <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z" ></path> </svg>
                        </button>
                        <button class="card4">
